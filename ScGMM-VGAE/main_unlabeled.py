...
# These main codes are used for clustering the unlabeled data
...
from model_CUDA_unlabeled import GMM_VGAE
...
print("chu")
nClusters = 6
adj, features, labels = load_data('chu', './data/chu', True)
