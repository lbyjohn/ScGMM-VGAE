# Following codes are to pre-process the input files
# The codes are based on Eric Lin's codes (https://github.com/ericlin1230/scGMM-VGAE)
...
def load_data(dataset, data_path, modified):
    ...
    Args:
        ...
        modified: Whether the data is modified for no combination

    Returns:
        _type_: Return the adjacency matrix, feature matrix and label
    """
