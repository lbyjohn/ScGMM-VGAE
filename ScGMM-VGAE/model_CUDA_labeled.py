...
# These models are used for clustering labeled data
# The codes here are further modified based on Eric Lin's codes (https://github.com/ericlin1230/scGMM-VGAE) to contain NMI and SC metrics evaluation
